      ...
      {[...Array(12)].map((_, idx) => (
        ...
        />
          ...
          <section style={{ padding: '4rem 2rem', maxWidth: '1000px', margin: '0 auto' }}>
            ...
            <h2 style={{ fontSize: '2.5rem', marginBottom: '3rem', fontWeight: 'normal' }}>Everything you need to know, at a glance.</h2>
            ...
            <div style={{ display: 'grid', gap: '1.5rem', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))' }}>
              <div style={{ backgroundColor: '#F9F7F4', padding: '2rem', borderRadius: '12px' }}>
                ...
                <p style={{ color: '#666', fontSize: '0.95rem' }}>Quick enough for toddlers, long enough for a real gallery of moments.</p>
              </div>
              <div style={{ backgroundColor: '#F9F7F4', padding: '2rem', borderRadius: '12px' }}>
                <div style={{ fontSize: '2.5rem', marginBottom: '1rem' }}>📅</div>
                <h3 style={{ fontSize: '1.3rem', marginBottom: '0.5rem', fontWeight: 'normal' }}>Summer 2026</h3>
                <p style={{ color: '#666', fontSize: '0.95rem' }}>Saturday and Sunday afternoon time slots, scheduled around golden hour.</p>
              </div>
              <div style={{ backgroundColor: '#F9F7F4', padding: '2rem', borderRadius: '12px' }}>
                <div style={{ fontSize: '2.5rem', marginBottom: '1rem' }}>📍</div>
                <h3 style={{ fontSize: '1.3rem', marginBottom: '0.5rem', fontWeight: 'normal' }}>Langley/Surrey, BC</h3>
                <p style={{ color: '#666', fontSize: '0.95rem' }}>A lush, beautiful local area — exact location shared once you book.</p>
              </div>
              <div style={{ backgroundColor: '#F9F7F4', padding: '2rem', borderRadius: '12px' }}>
                <div style={{ fontSize: '2.5rem', marginBottom: '1rem' }}>💰</div>
                <h3 style={{ fontSize: '1.3rem', marginBottom: '0.5rem', fontWeight: 'normal' }}>$0 to reserve</h3>
                <p style={{ color: '#666', fontSize: '0.95rem' }}>No session fee. No deposit. Choose a photo package only after the shoot.</p>
              </div>
            </div>
          </section>
